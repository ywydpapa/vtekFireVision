...
sensorText1 = "sensor1" if os.getenv('sensor1') == None else os.getenv('sensor1')
sensorText2 = "sensor2" if os.getenv('sensor2') == None else os.getenv('sensor2')
sensorText3 = "sensor3" if os.getenv('sensor3') == None else os.getenv('sensor3')
sensorText4 = "sensor4" if os.getenv('sensor4') == None else os.getenv('sensor4')
app = Flask(__name__)
